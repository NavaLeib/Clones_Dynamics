...
for cells in [10 ** 4]:#[10**4, 10 ** 5,10**6]:
    ...
    for m in [10]:# [10, 10 ** 2, 10 ** 3]: #mean initial clone size
        ...
        for p in [5]:#[3,5]:  #dayes to passage
            ...
            for y in [5]:  #paercent to passage
                ...
                #analysis.figure_number_clones(passaging=p, initial_mean_clone_size=m,percent_of_pass=y, cells=cells)

                # analysis.figure_ratio_generation_many_mutants(number_of_mutations=2)
                #
                #analysis.figure_hist_many_mutants(number_of_mutations=2,generations_to_plot=[1,5])
